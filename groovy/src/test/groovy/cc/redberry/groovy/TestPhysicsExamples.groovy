...
//
//            println "DONE FACTOR"
            assertEquals M2, '(1/2)*(4*e**4*(m**2-t)**(-2)-16*e**4*(-u+m**2)**(-1)*(m**2-t)**(-1)+4*e**4*(-u+m**2)**(-2))*m**2*(s-2*m**2)-(1/2)*(u-m**2)*(16*e**4*(-u+m**2)**(-2)*m**2+16*e**4*(-u+m**2)**(-1)*m**2*(m**2-t)**(-1))-4*e**4*s*(-u+m**2)**(-1)*(m**2-t)**(-1)*(s-2*m**2)-16*e**4*(-u+m**2)**(-2)*m**4+4*e**4*(m**2-t)**(-1)*(s-2*m**2)+2*e**4*(u-m**2)*(-m**2+t)**(-1)-(1/2)*(u-m**2)*(16*e**4*m**2*(m**2-t)**(-2)-8*e**4*(-u+m**2)**(-1)*m**2*(m**2-t)**(-1))+2*e**4*(u-m**2)**(-1)*(-m**2+t)-(1/2)*(16*e**4*(-u+m**2)**(-2)*m**2-8*e**4*(-u+m**2)**(-1)*m**2*(m**2-t)**(-1))*(-m**2+t)+4*e**4*(-u+m**2)**(-1)*(s-2*m**2)+4*e**4*(-u+m**2)**(-2)*m**2*(-m**2+t)+(1/2)*(-12*e**4*(-u+m**2)**(-2)*m**2-12*e**4*m**2*(m**2-t)**(-2)+24*e**4*(-u+m**2)**(-1)*m**2*(m**2-t)**(-1))*(s-2*m**2)-4*e**4*s*(-u+m**2)**(-1)*m**2*(m**2-t)**(-1)-16*e**4*m**4*(m**2-t)**(-2)+4*e**4*(u-m**2)*m**2*(m**2-t)**(-2)-8*e**4*(-u+m**2)**(-1)*m**4*(m**2-t)**(-1)-(1/2)*(16*e**4*m**2*(m**2-t)**(-2)+16*e**4*(-u+m**2)**(-1)*m**2*(m**2-t)**(-1))*(-m**2+t)'.t
        }
    }
