 ...
 */
public class PermutationGroupImpTest {
    @Test
    public void test1() {
        Permutation b, c;
...
//        PermutationGroupImp pg = new PermutationGroupImp(new Permutation(1, 0, 2), new Permutation(1, 2, 0));
//        assertEquals(6L, pg.getOrder().longValue());
//        testIterator(pg);
//
//    }
//
//    public static void testIterator(PermutationGroupImp pg) {
...
//        PermutationGroupImp id = new PermutationGroupImp(10);
//
