...
import static cc.redberry.core.utils.HashFunctions.JenkinWang64shift;
...
public final class Algorithm1 {
    ...
    static ProductData algorithm1(final Tensor[] data, final Indices tIndices) {
        ...
        GraphStructureHashed structureOfContractionsHashed = new GraphStructureHashed(stretchIndices, hashedFreeContraction, hashedContractions);
    ...
    static int contractionsHashCode(long[] indexContractions) {
        ...
        for (long l : indexContractions)
            hash ^= 7 * hash + JenkinWang64shift(l);
