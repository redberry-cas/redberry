 ...
 * image of g according to ordering specified by {@link InducedOrdering}. The main algorithm used in this
 ...
 */
public class BacktrackIterator implements Iterator<Permutation> {
    ...
    public BacktrackIterator(List<BSGSElement> bsgs) {
        ...
        this.baseComparator = new InducedOrdering(AlgorithmsBase.getBaseAsArray(bsgs));
        //permutation word
