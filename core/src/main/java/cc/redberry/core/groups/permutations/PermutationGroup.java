...
public final class PermutationGroup
    ...
    /**
     * Extends this group with specified generators, i.e. returns a union of this and generators.
     *
    ...
    public PermutationGroup derivedSubgroup() {
        ...
        if (isSymmetric())
            return derivedSubgroup = PermutationGroupFactory.alternatingGroup(degree);
        if (isAlternating() && degree > 4)
