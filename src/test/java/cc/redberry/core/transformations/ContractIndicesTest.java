...
//    }
    ...
    public void test2211() {
        ...
        Expression lambda = Tensors.parseExpression("\\lambda=0");
        ...
        parse("N^\\lambda_\\rho");
        parse("n_\\lambda");
        parse("HATK^{\\alpha \\beta \\gamma }_{\\delta }");
        parse("HATK^{\\beta \\gamma }_{\\delta }");
        parse("HATK^{\\gamma }_{\\delta }");
        parse("HATS^{\\alpha \\gamma }_{\\delta } ");
        parse("HATS^{\\gamma }_{\\delta }");
        parse("HATW^{\\gamma }_{\\delta }");
        parse("HATN^{\\gamma }_{\\delta }");
        parse("HATM^{\\gamma }_{\\delta }");
        ...
        parse("ACTION");
        parse("Flat^{\\gamma }_{\\delta } + WR^{\\gamma }_{\\delta } + SR^{\\gamma }_{\\delta } + SSR^{\\gamma }_{\\delta } + FF^{\\gamma }_{\\delta } + FR^{\\gamma }_{\\delta } + RR^{\\gamma }_{\\delta }");
        parse("NABLAS_{\\mu_{9} }^{\\alpha \\gamma }_{\\delta }");
        parse("NABLAS_{\\mu_{9} }^{\\gamma }_{\\delta }");
        parse("HATF_{\\mu \\nu }");
        parse("DELTA1");
        parse("DELTA2");
        parse("DELTA3");
