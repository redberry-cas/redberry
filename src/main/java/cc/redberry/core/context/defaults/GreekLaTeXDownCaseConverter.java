...
public final class GreekLaTeXDownCaseConverter extends SymbolArrayConverter {
    public static final byte converterID = 2;
    static final String[] symbols = new String[23];
    static final String[] utf = new String[23];
...
//        symbols[17]= "final sigma??"
    ...
    private GreekLaTeXDownCaseConverter() {
        super(symbols, utf);
    }
