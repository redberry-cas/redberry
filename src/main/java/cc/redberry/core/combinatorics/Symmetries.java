...
public class Symmetries implements Iterable<Symmetry> {
     ...
     * i.e. empty symmetries. It returns empty iterator and throws
     * {@code IllegalStateException} when trying to add any {@code Symmetry}.
     * The dimension of empty symmetries is zero.
     *
     * @see EmptyIterator
     */
    public static final Symmetries EMPTY_SYMMETRIES = new Symmetries(0) {
        ...
        /**
         * This method throws {@code IllegalStateException} due to this
         * symmetries is empty.
         */
        @Override
    ...
    /**
     * Create {@code Symmetries}, which contains symmetries with specified
     ...
     *
     * <h4><a name="Symmetries">Examples:</a></h4> Trying to add {@code new Symmetry(new int[]{0,1,2},true)},
    ...
    /**
     * Appends the specified array of {@code Symmetry} to this {@code Symmetries}.
     ...
     * permutation array in one-line notation and boolean sign, to this {@code Symmetries}.
     * If inconsistent {@code Symmetry} adding it throws
     * {@code InconsistentGeneratorsException}. Note, that some times it is
     * difficult for human to understand that adding symmetry is inconsistent.
     *
    ...
    @Override
    public Symmetries clone() {
        return new Symmetries(new ArrayList<>(symmetries), dimension);
    }
    ...
    public static Symmetries getFullSymmetries(int dimension) {
        ...
        Symmetries symmetries = new Symmetries(dimension);
        ...
        symmetries.add(cycleSymmetry);
        symmetries.add(transpositionSymmetry);
        return symmetries;
    }
    ...
    public static Symmetries getFullSymmetriesForSortedIndices(int upperCount, int lowerCount) {
        ...
        if (upperCount <= 1 && lowerCount <= 1)
            return EMPTY_SYMMETRIES;
        Symmetries symmetries = new Symmetries(upperCount + lowerCount);
        ...
        if (upperCount > 1) {
            ...
            symmetries.add(upperTranspositionSymmetry);
        }
        ...
        if (lowerCount > 1) {
            ...
            symmetries.add(lowerTranspositionSymmetry);
        }
        ...
        if (upperCount > 2) {
            ...
            symmetries.add(upperCycleSymmetry);
        }
        if (lowerCount > 2) {
            ...
            symmetries.add(lowerCycleSymmetry);
        }
